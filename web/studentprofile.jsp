...
<form action="evaluate.html" method="post">
  <tbody>
      ...
      <tr>
          ...
          <td><input type="submit"  name="registrationID" placeholder="Evaluate" value="<%=records.getString("registrationID") %>" >
          
			
          <!-- <a href="evaluationForm.jsp" class="action-button shadow animate blue"> -->
      </tr>
    <%} %>	
  </tbody>
 </form>
